...
\section{Portefolio}
    ...
    \subsection{BdE}
        ...
        %\includegraphics[]{img/color-purchases-lrg.png}
        %\includegraphics[width=0.9\textwidth]{img/mde.jpg}
        
        \includegraphics[width=0.9\textwidth]{img/arbre.png}
    ...
    \subsection{24h de l'Insa}
        ...
        \includegraphics[]{img/affiche-soiree.png}
        \includegraphics[]{img/IMG_5730.JPG}
        \includegraphics[]{img/IMG_5741.JPG}
        \includegraphics[]{img/IMG_5792.JPG}
        \includegraphics[]{img/IMG_5848.JPG}
        \includegraphics[]{img/logo-TShirt-bichro.png}
        \includegraphics[]{img/main.png}
        \includegraphics[]{img/oldschool.png}
        \includegraphics[]{img/preAffiche_panda_2hot.png}
        \includegraphics[]{img/preAffiche_panda_2leaf_date1.png}
        \includegraphics[]{img/preAffiche_panda_2leaf_date2.png}
        \includegraphics[]{img/preAffiche_panda_2.png}
        \includegraphics[]{img/preAffiche_panda_3-2.png}
        \includegraphics[]{img/preAffiche_panda_3-3.png}
        \includegraphics[]{img/preAffiche_panda_3.png}
        \includegraphics[]{img/preAffiche_panda.png}
        \includegraphics[]{img/preAffiche.png}
        %TODO get png \includegraphics[]{img/splash24.svg}
